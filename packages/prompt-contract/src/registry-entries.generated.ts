...
export const REGISTRY_ENTRIES: SectionDescriptor[] = [
  ...
  },
  {
    ...
    "role": "system",
    "position": "head",
    "description": "run_terminal_command 默认 cwd + $MUSE_WORKSPACE 用法约定 + envelope hint 指针",
    "writerLocations": [
  ...
  },
  {
    ...
    "position": "mid",
    "tier": "high-risk",
    "description": "Shell 命令执行（union 4-case status 分流 + $MUSE_WORKSPACE / cwd 契约 + 等待场景矩阵 6 行 + 工具偏好清单 + 禁交互命令 + wait_ms:0 长任务背景化 + status=running 由 push 通知激活下一轮）",
    "writerLocations": [
